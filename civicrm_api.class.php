...
// CiviCRM API class, gebruikt om verbinding te maken met de remote CiviCRM-installatie
// Versie 4.4.6, https://github.com/civicrm/civicrm-core/blob/4.4.6/api/class.api.php
...
class civicrm_api3 {
  ...
  function remoteCall($entity, $action, $params = array()) {
    ...
    $fields .= '&json=' . json_encode($params);
